...
import { deleteMessage } from '../../../features/mensajeSlice';
...
export const AlertaEliminar = ({ row }) => {
    ...
    return (
        <>
            <Tooltip hasArrow label={user.usuario.role !== 'ADMIN' ? 'No tiene privilegios para realizar esta acción' : 'Eliminar'} placement='auto'>
                <IconButton
                    aria-label="Eliminar"
